...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2025 at 06:01 PM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllAttendanceLogs` (IN `p_LogID` INT)   BEGIN
    SELECT * FROM attendance_Log WHERE LogID = p_LogID;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllEmployees` ()   BEGIN
    SELECT EmployeeID, FirstName, LastName, Position, ContactNumber, Email
    FROM employee_info;
END$$
...
(10001, 'Juan', 'Dela Cruz', '09171234567', 'juan.delacruz@example.com', '123 Sampaguita St., Quezon City', 'Software Developer', '2024-06-01', '12345'),
(10002, 'Maria', 'Santos', '09181234567', 'maria.santos@example.com', '456 Mabini St., Makati City', 'HR Manager', '2023-11-15', '23456'),
(10003, 'Jose', 'Reyes', '09191234567', 'jose.reyes@example.com', '789 Bonifacio Ave., Taguig City', 'Accountant', '2022-04-10', '34567'),
(10004, 'Ana', 'Lopez', '09201234567', 'ana.lopez@example.com', '321 Rizal Blvd., Pasig City', 'Marketing Officer', '2021-09-30', '45678'),
(10005, 'Carlos', 'Torres', '09211234567', 'carlos.torres@example.com', '654 Katipunan Ave., Manila', 'IT Support', '2020-01-20', '56789');
...
(2917, 'Cheska', 'De Castro', '09938309279', NULL, '$2y$10$rx7FZs3Tw4tXSRGX1YocN.5pg59/xX6Lbs9vxlCyyxvnZAWuR1do2'),
(20001, 'Isabella', 'Garcia', '09981234567', 'isabella.garcia@company.com', '$2y$10$Aal0MBxCqDxZDkaugyYjwuLYzs3VAMR9a53IfNf3T6urRmrRtfcHC'),
(20002, 'Miguel', 'Navarro', '09992234567', 'miguel.navarro@company.com', '$2y$10$h9l/QhZ93KiSyApoq2odV.aXS.Bs6h5ofbJ/u/xBYHuvcmjOthU6u'),
(2336324, 'Sean', 'Del Rosario', '09065816503', 'seanmdelrosario@gmail.com', '$2y$10$J0VRm4EqgYCm3h8FcQZthuc016dKcSCn1M2QMjaK5SV4TxC7HjPUi');
...
--
ALTER TABLE `employee_info`
  MODIFY `EmployeeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10006;
